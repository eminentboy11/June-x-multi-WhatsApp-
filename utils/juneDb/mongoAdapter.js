...
/**
 * Hot-remove support: close only this bot's MongoDB adapter and remove it from
 * the registry. A later hot-add receives a fresh adapter/client, while every
 * other bot keeps its own client untouched.
 */
